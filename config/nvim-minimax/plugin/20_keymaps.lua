...
local pick_at_filedir = function()
  local fcwd = vim.fn.expand('%:p:h')
  local opts = { source = { cwd = fcwd } }
...
nmap_leader('fF', pick_at_filedir,                              'Files at file directory)')
...
nmap_leader('lx', '<Cmd>:Executioner<CR>',                      'Executioner')
...
local toggle_lsp_inlay_hint = function()
...
nmap_leader('oR', toggle_relative_number,                  'Toggle relative number')
