...
local now_if_args = function(f, enabled)
  ...
  if enabled then _G.Config.now_if_args(f) end
end
...
now_if_args(function()
  ...
  vim.lsp.config('*', {
    capabilities = {
      ...
      -- inlay_hints = { enabled = true, enable = true }
    },
    -- keys = {
...
later(function()
  ...
  require('lazydev').setup({
    library = {
      ...
      -- 'mini.ai',
      -- '~/.local/share/nvim-minimax/site/pack/deps/start/mini.nvim/lua/mini',
  ...
  tt.setup({
    size = function(term)
      if term.direction == "horizontal" then
        return 0.35 * vim.o.lines
      elseif term.direction == "vertical" then
        return 0.23 * vim.o.columns
      end
      -- floats?
      return 20
    end,
